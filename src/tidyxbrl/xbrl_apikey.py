...
def xbrl_apikey(username='', password='', client_id='', client_secret='', platform='pc', grant_type='password', refresh_token=''):
    ...
    Outputs:
        xbrl_apikeyoutput: Pandas DataFrame output of the XBRL api key
            ...
            - refresh_token: Refresh token to refresh the 'access_token'. Can be passes back to the function with a 'refresh_token' grant_type
    ...
    Examples:
        xbrl_apikeyoutput = xbrl_apikey(username='username', password='password', client_id='client_id', client_secret='client_secret', platform='pc', grant_type='password', refresh_token='refresh_token')
    """
    ...
    # If refresh_token, refresh an existing token
        ...
        raise ValueError("grant_type must be either 'password','refresh_token'")
