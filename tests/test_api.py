...
dataresponse = tidyxbrl.xbrl_apiquery(access_token=response.access_token.values[0], 
...
dataresponse2 = tidyxbrl.xbrl_apiquery(access_token=response.access_token.values[0], 
